...
class Gaaaaaaame3Fragment : Fragment() {
    ...
    private var fragmentS2Binding: FragmentGaaaaaaame3Binding? = null
    private val binding
        get() = fragmentS2Binding ?: throw RuntimeException("FragmentGaaaaaaame3Binding = null")
    ...
    override fun onCreateView(
        ...
        fragmentS2Binding = FragmentGaaaaaaame3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun gtgthhgthitghgt() {
        findNavController().navigate(R.id.action_gaaaaaaame3Fragment_to_gaaaaaaaReeeeloadFragment)
    }
}